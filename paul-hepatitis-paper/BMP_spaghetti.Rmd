...
# hep_b file had some issues with creatinine, pt 11 creatinine 4 value was 133, an outlier, and was deleted
...
plot_data <- data.frame(
  ...
  days = as.vector(t(cbind(
    ...
    hep_b_bmp$date2,   # Day for titer 2
    hep_b_bmp$date3,    # Day for titer 3
    hep_b_bmp$date4,
    hep_b_bmp$date5
  ))),
...
ggsave("figure_outputs/bmp_creat_spaghetti.png", plot = plot_with_text, dpi = 300)
