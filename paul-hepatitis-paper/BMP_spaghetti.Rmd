...
#BMP formatting
hep_b_bmp <- hep_b_clean[, c(1,2,15:17, 28:30, 41:43, 54:56, 67:69)]
...
#BMP formatting
hep_c_bmp <- hep_c_clean[, c(1,2,15:17, 28:30, 41:43, 54:56, 67:69)]
hep_c_bmp$`Date of BMP 1` <- as.Date(hep_c_bmp$`Date of BMP 1`, format = "%Y-%m-%d")
hep_c_bmp$`Date of BMP 2` <- as.Date(hep_c_bmp$`Date of BMP 2`, format = "%Y-%m-%d")
hep_c_bmp$`Date of BMP 3` <- as.Date(hep_c_bmp$`Date of BMP 3`, format = "%Y-%m-%d")
hep_c_bmp$`Date of BMP 4` <- as.Date(hep_c_bmp$`Date of BMP 4`, format = "%Y-%m-%d")
hep_c_bmp$`Date of BMP 5` <- as.Date(hep_c_bmp$`Date of BMP 5`, format = "%Y-%m-%d")
...
#remove subject 38's creatinine 3, as it a heavy outlier at 20
hep_c_bmp[38,9] <- NA
...
ggsave("figure_outputs/hcbmp_creat_spaghetti.png", plot = plot_with_text, dpi = 300)
...
ggsave("figure_outputs/hcbmp_NA_spaghetti.png", plot = plot_with_text, dpi = 300)
